...
public class Exercicio06 {
	...
	public static void main(String[] args) {
		...
		// Letra D
		double[] total = valorTotal(matriz);

		for (int e = 0; e < 4; e++) {
			System.out.println(estados[e] + ": " + formataMoeda.format(total[e]));
		}
	...
	public static double[] valorTotal(int[][] matriz) {
		...
		for (int e = 0; e < 4; e++) {
			for (int r = 0; r < 3; r++) {// move
				...
				total[e] += matriz[e][r] * preco[r];
			}
		}

		System.out.println("");
		System.out.println("Letra D - Vendas por Estado");
		System.out.println("");
